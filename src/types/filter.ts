...
type PickKeys<Filter> = {
  [Key in keyof Filter as SnakeCase<Exclude<Key, keyof LucidFilter | "constructor">>]: Filter[Key] extends (value: infer V, ...args: any) => any
    ? V
    : never;
};
 ...
 */
export type InputObject<Instance extends InstanceType<LucidFilterContract>> = Partial<PickKeys<Instance>> &
